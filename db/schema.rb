...
<<<<<<< HEAD
ActiveRecord::Schema[7.0].define(version: 2022_11_17_051700) do
=======
ActiveRecord::Schema[7.0].define(version: 2022_11_17_024415) do
>>>>>>> master
  ...
  create_table "homestays", force: :cascade do |t|
    ...
    t.float "latitude"
    t.float "longitude"
    t.index ["user_id"], name: "index_homestays_on_user_id"
  end
